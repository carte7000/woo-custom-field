...
.premium-box-container .description:nth-child(odd) .pho-images-bg {background: #f1f1f1 url(<?php echo $plugin_dir_url; ?>assets/images/image-frame-odd.png) no-repeat 100% top;}
.premium-box-container .description:nth-child(even) .pho-images-bg {background: #f1f1f1 url(<?php echo $plugin_dir_url; ?>assets/images/image-frame-even.png) no-repeat 100% top;}
        ...
        <div class="premium-box-container">
                ...
                <div class="pho-desc-head"><h2>General Settings</h2></div>
                    ...
                    <div class="pho-plugin-content">
                        ...
                        <img src="<?php echo $plugin_dir_url; ?>assets/images/general-settings.png" />
                        </div>
                    </div>
				</div> <!-- description end -->
                ...
                <div class="pho-desc-head"><h2>Custom Input Fields</h2></div>
                    ...
                    <div class="pho-plugin-content">
                        ...
                        <div class="pho-images-bg">
                        <img src="<?php echo $plugin_dir_url; ?>assets/images/custom input fields.png" />
                        </div>
                    </div>
				</div> <!-- description end -->
            ...
            <div class="description">
                <div class="pho-desc-head"><h2>Section Style</h2></div>
                    ...
                    <div class="pho-plugin-content">
                        ...
                        <div class="pho-images-bg">
                        <img src="<?php echo $plugin_dir_url; ?>assets/images/section style.png" />
                        </div>
                    </div>
            </div> <!-- description end -->
            ...
            <div class="description">
                <div class="pho-desc-head"><h2>Option Description Type</h2></div>
                    ...
                    <div class="pho-plugin-content">
                        ...
                        <div class="pho-images-bg">
                        <img src="<?php echo $plugin_dir_url; ?>assets/images/option description type.png" />
                        </div>
                    </div>
            </div> <!-- description end -->
            ...
            <div class="description">
                <div class="pho-desc-head"><h2>Option Price Type</h2></div>
                    ...
                    <div class="pho-plugin-content">
                        ...
                        <div class="pho-images-bg">
                        <img src="<?php echo $plugin_dir_url; ?>assets/images/option price type.png" />
                        </div>
                    </div>
            </div> <!-- description end -->
			...
			<div class="description">
                <div class="pho-desc-head"><h2>Option Label Position</h2></div>
                    ...
                    <div class="pho-plugin-content">
                        ...
                        <div class="pho-images-bg">
                        <img src="<?php echo $plugin_dir_url; ?>assets/images/option label position.png" />
                        </div>
                    </div>
            </div> <!-- description end -->
            ...
            <div class="description">
                <div class="pho-desc-head"><h2>Required Fields</h2></div>
                    ...
                    <div class="pho-plugin-content">
                        ...
                        <div class="pho-images-bg">
                        <img src="<?php echo $plugin_dir_url; ?>assets/images/required fields.png" />
                        </div>
                    </div>
            </div> <!-- description end -->
            ...
            <div class="description">
                <div class="pho-desc-head"><h2>Add  image</h2></div>
                    ...
                    <div class="pho-plugin-content">
                        ...
                        <div class="pho-images-bg">
                        <img src="<?php echo $plugin_dir_url; ?>assets/images/image-option.png" />
                        </div>
                    </div>
            </div> <!-- description end -->
            ...
            <div class="description">
                <div class="pho-desc-head"><h2>Range Type</h2></div>
                    ...
                    <div class="pho-plugin-content">
                        ...
                        <div class="pho-images-bg">
                        <img src="<?php echo $plugin_dir_url; ?>assets/images/range type.png" />
                        </div>
                    </div>
            </div> <!-- description end -->
            ...
            <div class="description">
                <div class="pho-desc-head"><h2>Conditional Logic</h2></div>
                    ...
                    <div class="pho-plugin-content">
                        ...
                        <div class="pho-images-bg">
                        <img src="<?php echo $plugin_dir_url; ?>assets/images/conditional logic.png" />
                        </div>
                    </div>
            </div> <!-- description end -->
			...
			<div class="description">
                <div class="pho-desc-head"><h2>Styling Options</h2></div>
                    ...
                    <div class="pho-plugin-content">
                        ...
                        <div class="pho-images-bg">
                        <img src="<?php echo $plugin_dir_url; ?>assets/images/Styling Options.png" />
                        </div>
                    </div>
            </div> <!-- description end -->
