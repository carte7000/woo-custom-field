					...
					<table cellspacing="0" cellpadding="0">
						<thead>
							<tr>
								...
								<th class="minmax_column"><?php _e('Max', 'custom-variation'); ?></th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td class="minmax_column"><input class="clear_class<?php echo $variation_id.$loop; ?>" type="number" name="product_option_max[<?php echo $variation_id; ?>][<?php echo $loop; ?>]" value="<?php echo esc_attr( $option['max'] ) ?>" placeholder="N/A" min="0" step="any" /></td>
							</tr>
						</tbody>
					</table>
				</td>
