...
**/
	...
	if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) 
	{
		...
		function PHOEN_variable_fields_process($post_id){
			...
			$variation_id= array_map( 'sanitize_text_field', $_POST['variation_id'] );
			...
			if(isset($_POST) && is_array($variation_id)){
				...
				for($m=0;$m <= count($variation_id);$m++){
					...
					if ( isset( $_POST[ 'product_option_name' ][$vvgat_id] ) && !empty($_POST[ 'product_option_name' ][$vvgat_id]) ) 
					{
						...
						$option_name  = array_map( 'sanitize_text_field', $_POST['product_option_name'][$vvgat_id] );
						
						$option_type  = array_map( 'sanitize_text_field', $_POST['product_option_type'][$vvgat_id] );
						
						$option_position  = array_map( 'sanitize_text_field', $_POST['product_option_position'][$vvgat_id]);
						...
						$option_label = array_map( 'sanitize_text_field', $_POST['product_option_label'][$vvgat_id]);
						
						$option_price = array_map( 'sanitize_text_field', $_POST['product_option_price'][$vvgat_id]);
						
						$option_max   = array_map( 'sanitize_text_field', $_POST['product_option_max'][$vvgat_id]);
